...
public class Test8_AppManagement {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            driver.removeApp("com.swasin.CalculatorApp");

            if (!driver.isAppInstalled("com.swasin.CalculatorApp")) {
                driver.installApp("/Users/ashutoshpal/Desktop/iOS_apps/CalculatorApp.app");
                System.out.println("App successfully installed");
            }
            else
                System.out.println("App already installed");

            driver.activateApp("com.swasin.CalculatorApp");

            driver.terminateApp("com.swasin.CalculatorApp");
